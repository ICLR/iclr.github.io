...
if path.exists("cached_or"):
    ...
    notes = c.get_notes(invitation='ICLR.cc/2020/Conference/-/Blind_Submission') + \
                                    c.get_notes(invitation='ICLR.cc/2020/Conference/-/Blind_Submission', offset=1000, limit=1000) + \
                                    c.get_notes(invitation='ICLR.cc/2020/Conference/-/Blind_Submission', offset=2000, limit=1000)
